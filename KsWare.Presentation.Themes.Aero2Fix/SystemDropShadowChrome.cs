// Type: Microsoft.Windows.Themes.SystemDropShadowChrome
...
namespace KsWare.Presentation.Themes.Aero2Fix //Microsoft.Windows.Themes
{
	...
	public sealed class SystemDropShadowChrome : Decorator {
		...
		public Color Color { get { return (Color) this.GetValue(SystemDropShadowChrome.ColorProperty); } set { this.SetValue(SystemDropShadowChrome.ColorProperty, (object) value); } }

		public CornerRadius CornerRadius { get { return (CornerRadius) this.GetValue(SystemDropShadowChrome.CornerRadiusProperty); } set { this.SetValue(SystemDropShadowChrome.CornerRadiusProperty, (object) value); } }
		...
		private static void ClearBrushes(DependencyObject o, DependencyPropertyChangedEventArgs e) { ((SystemDropShadowChrome) o)._brushes = (Brush[]) null; }
		...
		private Brush[] GetBrushes(Color c, CornerRadius cornerRadius) {
			...
			if (c == ((SolidColorBrush) SystemDropShadowChrome._commonBrushes[4]).Color && cornerRadius == SystemDropShadowChrome._commonCornerRadius) {
				...
				if (this._brushes == null) this._brushes = SystemDropShadowChrome.CreateBrushes(c, cornerRadius);
