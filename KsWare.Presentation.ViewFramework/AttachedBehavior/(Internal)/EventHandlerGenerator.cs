...
namespace KsWare.Presentation.ViewFramework.AttachedBehavior 
{
	...
	internal static class EventHandlerGenerator 
	{
		...
		public static Delegate CreateDelegate(Type eventHandlerType, MethodInfo methodToInvoke, object methodInvoker) {
			...
			if(eventHandlerInfo.ReturnParameter==null) throw new NotImplementedException("Event handler has no return parameter! UniqueID: {A413A625-239F-463D-B960-603754317F8A}");
			Type returnType = eventHandlerInfo.ReturnParameter.ParameterType;
			if (returnType != typeof(void))
				throw new InvalidOperationException("Delegate has a return type. This generator only supports event handlers that are void");
