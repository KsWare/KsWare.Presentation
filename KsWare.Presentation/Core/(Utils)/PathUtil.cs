		...
		public static string ApplicationPath {
			get {
				...
				if(Assembly.GetEntryAssembly()==null) {
					//if entry assemply is null return the path of calling assembly
					var path = Path.GetDirectoryName(new Uri(callingAssembly.CodeBase, UriKind.Absolute).LocalPath);
					return path;
				}
