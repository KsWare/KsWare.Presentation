...
namespace KsWare.Presentation.ViewModelFramework {
	...
	public class BusinessObjectVM<TBusinessObject>:ObjectVM,IBusinessObjectVM where TBusinessObject:class,IObjectBM {
		...
		public TBusinessObject BusinessObject { get => (TBusinessObject)Metadata.DataProvider.Data; set => Metadata.DataProvider.Data = value; }

		IObjectBM IBusinessObjectVM.BusinessObject { get => BusinessObject; set => BusinessObject = (TBusinessObject) value; }
