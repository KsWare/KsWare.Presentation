...
namespace KsWare.Presentation.BusinessFramework {
	...
	public class BusinessMetadata:IMetadata,IParentSupport, IParentSupport<IObjectBM> {
		...
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes")]
		IObjectBM IParentSupport<IObjectBM>.Parent {get => BusinessObject; set => BusinessObject=value; }
		...
		protected Lazy<EventSourceStore> LazyWeakEventProperties => _lazyWeakEventProperties;

		protected EventSourceStore EventSources => _lazyWeakEventProperties.Value;
