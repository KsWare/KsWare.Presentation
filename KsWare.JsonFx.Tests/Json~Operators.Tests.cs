...
namespace KsWare.JsonFx.Test {
	...
	[TestClass]
	public class Json_OperatorsTests {
		...
		[TestMethod][Ignore] public void OpJsonDoubleAddAddC(){var j=new Json(1.0,false,true);var k=j++; Assert.AreEqual(1.0, (double)k);}
		[TestMethod] public void OpJsonDoubleAddAddD(){var j=new Json(1.0,false,true);var k=++j; Assert.AreEqual(2.0, (double)k);}
